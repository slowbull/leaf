...
MODEL_PARAMS = {
    ...
    'femnist.cnn_mom': (0.0003, 62), # lr, num_classes
    'shakespeare.stacked_lstm': (0.0003, 80, 53, 128) # lr, seq_len, num_classes, num_hidden
    #'shakespeare.stacked_lstm': (0.0003, 80, 53, 100) # lr, seq_len, num_classes, num_hidden
}
